...
console.log('🔥 Firebase Setup for SnapFix');
console.log('==============================\n');

console.log('📋 Follow these steps to set up Firebase:\n');

console.log('1. 🌐 Go to Firebase Console: https://console.firebase.google.com/');
console.log('2. ➕ Create a new project named "snapfix-hyderabad"');
...
console.log('✅ Setup complete! Your SnapFix app will now store real data in Firebase.');
